...
Recovery passwords require at least 6 characters. The Pubky SDK recovery format
uses Argon2id, but longer, unpredictable passwords provide stronger protection.
