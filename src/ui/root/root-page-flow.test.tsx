...
import { RootPageFlow } from "./root-page-flow";
...
describe("RootPageFlow", () => {
  ...
  it("shows the landing page when no local identity exists", async () => {
    render(<RootPageFlow googleClientId="client" homegateBaseUrl="https://homegate.example/" />);
  ...
  it("routes a stored identity to the signed-in home state", async () => {
    ...
    const { container } = render(<RootPageFlow googleClientId="client" homegateBaseUrl="https://homegate.example/" />);
