...
function CheckIcon() {
  return <svg aria-hidden="true" className="size-4 shrink-0 text-brand" data-slot="selected-check" fill="none" viewBox="0 0 16 16"><path d="m2.67 8 3.55 3.56 7.11-7.12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" /></svg>;
}
