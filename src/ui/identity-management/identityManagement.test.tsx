...
describe("IdentityManagement", () => {
  ...
  it("copies the Pubky and resolved PKDNS homeserver with Figma ghost buttons", async () => {
    ...
    render(<IdentityManagement identity={identity} onBack={onBack} onDetachFromGoogle={vi.fn()} onDownloadBackup={vi.fn()} onLogOut={vi.fn()} resolveHomeserver={async () => Result.ok("homeserver-pubky")} />);
