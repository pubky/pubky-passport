...
Pubky SDK access and in-memory keypairs. `identity` owns browser identity controllers,
local persistence, and the colocated `google-backed-identity` lifecycle feature. A
