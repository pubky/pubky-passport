  ...
  return (
    <PassportScreen className="gap-8">
      <div className="flex flex-col gap-6 md:gap-3">
        <h1 aria-label="Backup your pubky first." className="text-5xl font-bold leading-none md:text-6xl">
      ...
      <PassportNavigation
        ...
        confirm={<Button className="w-full" onClick={onRecoveryConfirmed} size="lg" type="button">
          <CheckIcon />
...
function RecoveryMethodButton({ children, icon, onClick }: {
  ...
  return (
    <Button className="w-full md:h-[60px] md:px-8 md:py-5" onClick={onClick} type="button" variant="secondary">
      {icon}
      {children}
    </Button>
  );
