...
describe("RecoveryBeforeDetaching", () => {
  ...
  it("supports returning and opening the recovery-file screen", async () => {
    ...
    render(<RecoveryBeforeDetaching onBack={onBack} onRecoveryConfirmed={onRecoveryConfirmed} onDownloadRecoveryFile={onDownloadRecoveryFile} onMigrateToKeychain={onMigrateToKeychain} />);
