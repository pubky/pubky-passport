  ...
  return (
    <PassportScreen className="gap-8">
      <div className="flex flex-col gap-6">
        ...
        <Image alt="" aria-hidden="true" className="mx-auto size-[200px]" data-slot="setup-complete-illustration" height={200} src="/illustrations/passport-setup-complete-source.png" unoptimized width={200} />
      </div>
